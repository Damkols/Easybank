...
const Navbar: React.FunctionComponent = () => {
  ...
  return (
    <nav className="navbar">
      ...
      <button className={`navbar__toggle-btn ${isActive && "active"}`} onClick={() => setIsActive(!isActive)}>
        <span className="one"></span>
        <span className="two"></span>
        <span className="three"></span>
      </button>

      <ul className={`navbar__nav ${isActive && "active"}`}>
        <li><a href="#home" onClick={() => setIsActive(!isActive)}>Home</a></li>
        <li><a href="#" onClick={() => setIsActive(!isActive)}>About</a></li>
        <li><a href="#" onClick={() => setIsActive(!isActive)}>Contact</a></li>
        <li><a href="#blog" onClick={() => setIsActive(!isActive)}>Blog</a></li>
        <li><a href="#" onClick={() => setIsActive(!isActive)}>Careers</a></li>
      </ul>

      <button className="navbar__btn-primary">Request Invite</button>
    </nav>
  )
}
